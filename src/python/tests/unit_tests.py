...
class Test(TestCase):
    def test_map_method(self):
        input_pair = (1, "127.0.0.1,djecvwmjzejguvrqaryffwwzdasozsslizligyozikvhdeodyvsnotlkldsuvtbcmzajlfdqoopeiqrpfhqhneqrpzdzrgshthe,"
                         "1974-12-17,10.2,Xegqzir/8.7,PRT,PRT-PT,Portugalism,7\n")
        outputs = []
